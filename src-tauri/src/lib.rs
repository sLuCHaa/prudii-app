...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sieve::check_sieve_support,
            commands::sieve::get_vacation,
            commands::sieve::set_vacation,
            ...
            commands::tasks::count_open_tasks,
            ...
            commands::tasks::start_task_attachment_drag,
            ...
            commands::team::team_heartbeat,
            commands::team::team_list_assignments,
            commands::team::team_assign_mail,
            commands::team::team_set_assignment_status,
            commands::team::team_unassign,
            commands::mails::list_mails_by_message_ids,
